...
export default function Footer(props: any) {
  ...
  return (
    <div className="z-50 flex w-full flex-col items-center border-t bg-background p-0 pt-12">
      <div className="flex w-full flex-col md:flex-row">
        <div className="flex flex-col items-center p-10 pt-2 md:items-start">
          <CustomMotionDiv>
            <Link
              href={"/"}
              className="flex w-fit justify-center md:justify-start"
            >
          ...
          <CustomMotionDiv delay={0.1}>
            <div className="w-full pt-4 text-center text-sm text-muted-foreground md:text-start xl:whitespace-nowrap">
              {t("footer.tagline")}
            </div>
          </CustomMotionDiv>
...
const FooterLinksSection = (props: FooterLinksSectionProps) => {
  ...
  return (
    <div className="flex-grow p-6 text-center md:w-full md:max-w-xs md:flex-grow-0 md:text-start">
      {props.title && (
        <div className="mb-4 font-bold">{t(`${props.title}`)}</div>
      )}
...
const Copyrights = () => {
  ...
  return (
    <div className="flex w-full flex-col items-center justify-center bg-background p-4 px-6">
      <div className="flex w-full flex-row justify-between text-xs text-muted-foreground">
