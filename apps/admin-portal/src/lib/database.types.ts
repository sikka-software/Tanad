...
export type Database = {
  public: {
    Tables: {
      ...
      cars: {
        Row: {
          ...
          name: string;
          notes: Json | null;
          ownership_status: Database["public"]["Enums"]["vehicle_ownership_status"] | null;
    ...
    Enums: {
      activity_log_action_type: "INSERT" | "UPDATE" | "DELETE" | "CREATED" | "UPDATED" | "DELETED";
      ...
      invoice_status:
        ...
        | "written_off"
        | "archived";
      payment_cycle: "monthly" | "annual" | "daily" | "weekly" | "biweekly" | "quarterly";
      purchase_status:
        | "draft"
        | "issued"
        | "acknowledged"
...
export const Constants = {
  public: {
    Enums: {
      ...
      vehicle_ownership_status: ["owned", "financed", "rented"],
      vehicle_status: ["active", "maintenance", "sold", "totaled", "retired", "stored", "other"],
    },
  },
} as const;
