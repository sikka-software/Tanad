  ...
  try {
    ...
    try {
      ...
      return res.status(200).json({
        ...
        qrCode:
          "",
    ...
    try {
      ...
      const validationPassed = validationResult.output.includes(
