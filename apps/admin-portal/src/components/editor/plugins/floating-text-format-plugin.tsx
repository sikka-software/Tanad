...
function FloatingTextFormat({
  ...
  return (
    <div
      ...
      className="bg-background absolute start-0 top-0 z-10 flex gap-1 rounded-md border p-1 opacity-0 shadow-md transition-opacity duration-300 will-change-transform"
    >
      {editor.isEditable() && (
        <>
          <ToggleGroup
