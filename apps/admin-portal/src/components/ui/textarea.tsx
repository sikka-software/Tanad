  ...
  return (
    <textarea
      className={cn(
        ...
        !props.disabled &&
          "transition-all read-only:cursor-default read-only:rounded-none read-only:border-x-0 read-only:border-t read-only:border-b-transparent read-only:ps-0 read-only:shadow-none read-only:focus-visible:ring-0 read-only:focus-visible:outline-none",
