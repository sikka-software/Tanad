    ...
    return (
      <textarea
        className={cn(
          ...
          "transition-all read-only:cursor-default read-only:rounded-none read-only:border-x-0 read-only:border-t read-only:border-b-0 read-only:ps-0 read-only:shadow-none",
          className,
        )}
        ref={ref}
        {...props}
