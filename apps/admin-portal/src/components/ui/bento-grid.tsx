...
const BentoCard = ({
  ...
  >
    ...
    <div className="pointer-events-none absolute inset-0 transform-gpu [mask-image:linear-gradient(to_top,transparent_60%,#000_100%)] transition-all duration-300 group-hover:bg-black/[.5] group-hover:[mask-image:linear-gradient(to_top,transparent_60%,#000_100%)] dark:[mask-image:linear-gradient(to_top,transparent_60%,#000_100%)] group-hover:dark:bg-neutral-800 group-hover:dark:[mask-image:linear-gradient(to_top,transparent_60%,#000_100%)]" />
  </div>
);
