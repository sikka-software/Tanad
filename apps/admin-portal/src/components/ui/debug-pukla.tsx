...
const DebugPukla = () => {
  ...
  return (
    <div className="bg-background fixed end-2 bottom-2 z-[100] rounded-md border px-4 py-0">
      <Accordion type="single" collapsible>
        <AccordionItem value="item-1" className="min-w-[200px] !border-none">
          <AccordionTrigger>Current Pukla is</AccordionTrigger>
          <AccordionContent className="bg-muted-foreground/10 max-h-[200px] max-w-[200px] overflow-y-auto rounded-md p-2">
