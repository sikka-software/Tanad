...
export const ShareDialog: React.FC<ShareDialogType> = ({ openDialog, setOpenDialog, ...props }) => {
  ...
  if (size > 600) {
    ...
    return (
      <Sheet open={openDialog} onOpenChange={() => setOpenDialog(false)}>
        <SheetContent side="bottom" className="md:hawa-inset-x-[300px] hawa-rounded-t hawa-border">
