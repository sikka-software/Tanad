...
CREATE OR REPLACE FUNCTION public.module_log_client()
  RETURNS trigger
  LANGUAGE plpgsql
  SECURITY DEFINER
  SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.module_log_expense()
  RETURNS trigger
  LANGUAGE plpgsql
  SECURITY DEFINER
  SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.module_log_invoice()
  RETURNS trigger
  LANGUAGE plpgsql
  SECURITY DEFINER
  SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.module_log_job()
  RETURNS trigger
  LANGUAGE plpgsql
  SECURITY DEFINER
  SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.module_log_office()
  RETURNS trigger
  LANGUAGE plpgsql
  SECURITY DEFINER
  SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.module_log_purchase()
  RETURNS trigger
  LANGUAGE plpgsql
  SECURITY DEFINER
  SET search_path TO 'public'
...
exception
  when others then
    -- Only raise a warning, do not re-raise the exception
    raise warning 'Error in module_log_purchase trigger: %', sqlerrm; -- Corrected from module_log_job_listing
...
CREATE OR REPLACE FUNCTION public.module_log_vendor()
  RETURNS trigger
  LANGUAGE plpgsql
  SECURITY DEFINER
  SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.module_log_warehouse()
  RETURNS trigger
  LANGUAGE plpgsql
  SECURITY DEFINER
  SET search_path TO 'public'
