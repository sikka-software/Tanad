import { pgTable, index, foreignKey, check, uuid, timestamp, text, jsonb, boolean, numeric, unique, date, varchar, pgPolicy, pgEnum } from "drizzle-orm/pg-core"
...
export const userRoles = pgTable("user_roles", {
	...
	unique("user_roles_user_id_role_enterprise_id_key").on(table.user_id, table.role, table.enterprise_id),
]);
