-- Function to log "employee requsts" changes to activity_logs
...
begin
  ...
  values (
    ...
    record_data.id,
    record_data.name, -- Use employee request name as target_name
    log_details
  );
...
CREATE TRIGGER log_employee_request_changes
