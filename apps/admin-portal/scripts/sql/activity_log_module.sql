...
CREATE OR REPLACE FUNCTION public.module_log_sikka()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
...
CREATE TRIGGER trigger_sikka_activity_log
AFTER INSERT OR UPDATE OR DELETE ON public.sikka
FOR EACH ROW EXECUTE FUNCTION public.module_log_sikka();
